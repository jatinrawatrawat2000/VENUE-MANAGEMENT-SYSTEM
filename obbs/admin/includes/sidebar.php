                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">VMS</span>|<span class="font-size-xl text-primary">ADMIN</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
{               ?>
                     ...
                     <li>
                                    ...
                                    <a href="CUSTOMER_BY_EVENT.php"><i class="si si-vector"></i><span class="sidebar-mini-hide">CUSTOMER_BY_EVENT</span></a>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-energy"></i><span class="sidebar-mini-hide">SERVICE FILTERS</span></a>
                                    <ul>
                                        <li>
                                            <a href="EXPENSIVE_PLACES_CATERS.php">EXPENSIVE_PLACES_CATERS</a>
                                        </li>
                                        <li>
                                            <a href="AFFORDABLE_PLACES_CATERS.php">AFFORDABLE_PLACES_CATERS</a>
                                        </li>
