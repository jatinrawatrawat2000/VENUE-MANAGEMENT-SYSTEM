...
<html lang="en">
<head>
<title>VENUE MANAGEMENT SYSTEM | Book Services</title>
					...
					<div class="agileinfo-contact-form-grid">
						<form method="post">
							 <div class="form-group row">
                                    <label class="col-form-label col-md-4">Booking Date From:</label>
                                    <div class="col-md-10">
                                        <input type="date" class="form-control" style="font-size: 20px" required="true" name="bookingfrom">
                                    </div>
                                </div>
                                               <div class="form-group row">
                                    <label class="col-form-label col-md-4">Booking Date To:</label>
                                    <div class="col-md-10">
