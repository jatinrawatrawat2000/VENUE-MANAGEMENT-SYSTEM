...
<html lang="en">
<head>
<title>VENUE MANAGEMENT SYSTEM|| Home Page
</title>
				...
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>Get in touch with certified, highly-trained experts to curate your requirements, at no extra cost..</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left w3-agileits-bottom-right">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>Personalize your decor and get all your queries answered instantly, aided by the latest tech.</p>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
